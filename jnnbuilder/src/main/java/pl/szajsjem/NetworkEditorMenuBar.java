...
import pl.szajsjem.jni.BeeDnnLibdll;
...
public class NetworkEditorMenuBar extends JMenuBar {
    ...
    private void showTrainingConfigDialog() {
        ...
        JComboBox<String> optimizerCombo = new JComboBox<>(BeeDnnLibdll.getOptimizers());
        JComboBox<String> lossCombo = new JComboBox<>(BeeDnnLibdll.getLossFunctions());
        JComboBox<String> regularizerCombo = new JComboBox<>(BeeDnnLibdll.getRegularizers());
